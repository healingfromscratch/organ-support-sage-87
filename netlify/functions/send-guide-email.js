  ...
  try {
    ...
    const enhancedEmailContent = `
      ...
      <div style="text-align: center; margin-bottom: 30px;">
        <img src="${logoUrl}" alt="Healing From Scratch" style="max-height:), as that was missing. However, this makes the symptoms uneven in other categories.argin: 0 auto; background: transparent;" />
      </div>
      ${emailContent}
